...
assert.match(createHtml, /create-promo\.css\?v=create-promo-light-v24/);
assert.match(createHtml, /create-promo-layout-cache\.js\?v=create-promo-light-v24/);
assert.match(createHtml, /create-promo\.js\?v=create-promo-light-v24/);
