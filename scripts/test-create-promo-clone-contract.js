...
assert.match(createHtml, /create-promo\.css\?v=create-promo-light-v26/);
assert.match(createHtml, /create-promo-layout-cache\.js\?v=create-promo-light-v26/);
assert.match(createHtml, /create-promo\.js\?v=create-promo-light-v26/);
...
assert.match(createJs, /contentColumn\.append\(dynamicSectionsWrapper, coverage\)/);
assert.match(createJs, /workspace\.append\(contentColumn, layoutPanel\)/);
