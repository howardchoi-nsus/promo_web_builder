...
assert.match(createHtml, /create-promo\.css\?v=create-promo-overview-v1/);
...
assert.match(createHtml, /wizard\/wizard-content\.js\?v=wizard-content-v3/);
assert.match(createHtml, /wizard\/promotion-overview\.js\?v=promotion-overview-v1/);
...
assert.match(createHtml, /create-promo\.js\?v=create-promo-light-v36/);
