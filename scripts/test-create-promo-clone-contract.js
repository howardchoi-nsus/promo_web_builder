...
assert.match(createHtml, /create-promo\.css\?v=create-promo-appearance-v20/);
assert.match(createHtml, /create-promo\.js\?v=create-promo-appearance-v20/);
...
assert.match(createJs, /ctaShapePreview:\s*true/);
assert.match(createJs, /ctaVariantPreview:\s*true/);
