...
assert.match(createJs, /resolveActiveTemplate\(wizardFormTemplates,\s*contentState\.formTemplate\)/);
assert.match(wizardJs, /resolveActiveTemplate\(wizardFormTemplates,\s*contentState\.formTemplate\)/);
