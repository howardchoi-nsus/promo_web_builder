...
assert.match(editorApp, /SectionCompositionControls/);
assert.match(editorApp, /:can-generate="sectionAiHasContent\(section\)"/);
...
assert.match(editorCss, /\.page-tree__status\.is-complete/);
assert.match(editorCss, /\.page-tree__status/);
