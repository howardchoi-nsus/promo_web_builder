...
assert.match(createHtml, /create-promo\.css\?v=create-promo-layout-sync-v23/);
assert.match(createHtml, /create-promo-layout-cache\.js\?v=create-promo-layout-sync-v23/);
assert.match(createHtml, /create-promo\.js\?v=create-promo-layout-sync-v23/);
