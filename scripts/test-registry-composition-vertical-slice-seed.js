...
assert.match(seed, /"assetRole":"hero-key-visual"/);
assert.match(seed, /"assetPromptText":"Create one distinctive campaign focal motif/);
assert.match(seed, /"imageAspectRatio":"4:3"/);
assert.match(seed, /'Split Hero','Concise copy with a bounded Hero key visual\.'/);
assert.match(seed, /"visual":\{"positionMode":"free","xPct":53,"yPx":70,"widthPct":39,"heightPx":420/);
