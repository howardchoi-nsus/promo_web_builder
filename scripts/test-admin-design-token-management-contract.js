...
assert.match(component, /saveAndApply/);
assert.match(component, /selectedTemplateIds/);
assert.match(component, /beforeunload/);
assert.match(service, /\/api\/design-token-set-clone/);
assert.match(service, /\/api\/wizard-form-template/);
...
assert.match(read("api/wizard-form-template-layout.js"), /designTokens: tokenVersion/);
