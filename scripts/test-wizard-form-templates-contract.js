...
assert.match(adminHtml, /v-for="\(section, sectionIndex\) in wizardFormTemplateDetail\.sections"/);
assert.match(adminHtml, /@click="addWizardFormTemplateSection"/);
assert.match(adminHtml, /@click="removeWizardFormTemplateSection\(section\)"/);
assert.match(adminHtml, /@click="moveWizardFormTemplateSection\(section, -1\)"/);
...
assert.match(adminHtml, /dropWizardFormTemplateSection\(section\)/);
