...
const sectionA = { id: "22222222-2222-4222-8222-222222222222", sectionKey: "promotionIntro", name: "Promotion Intro", status: "active", version: 1, aiDesign: { enabled: true } };
...
const component = { id: "55555555-5555-4555-8555-555555555555", componentKey: "cmp_1234567890abcdef1234567890abcdef", name: "Hero Title", status: "active", versionId: "66666666-6666-4666-8666-666666666666", version: 1, versionStatus: "active", fieldKind: "text", textType: "title" };
...
try {
  ...
  assert.equal(await page.getByText("Hero Title", { exact: true }).count() > 0, true);
