...
var Wo = {
	...
	setup(e) {
		...
		return Jn(() => {
			...
			E.value ? Q("", !0) : (Y(), X("header", Jo, [Z("div", Yo, [Z("div", Xo, [i[18] ||= Z("h1", { class: "shell-header__brand" }, "PROMO WEB BUILDER", -1), Z("span", Zo, L(T.value ? "Admin Template Layout" : "Visual Editor"), 1)])]), Z("div", Qo, [i[19] ||= Pi("<nav class=\"shell-nav\" aria-label=\"프로토타입 내비게이션\"><a href=\"/prototype/index.html\">프로모션 빌더</a><a href=\"/prototype/index.html?view=admin&amp;tab=promo-form\">관리자 페이지</a><a href=\"/promo-wizard.html\">Promo Wizard</a><a class=\"active\" href=\"/prototype/visual-editor.html\" aria-current=\"page\">Visual Editor</a><a href=\"/prototype/generated.html\">생성된 UI</a></nav><button class=\"shell-theme-toggle\" type=\"button\" data-shell-theme-toggle><span class=\"shell-theme-dot\" aria-hidden=\"true\"></span><strong data-shell-theme-label>Light</strong></button>", 2), Z("div", $o, L(T.value ? `Layout revision ${v.value}` : "편집 준비"), 1)])])),
