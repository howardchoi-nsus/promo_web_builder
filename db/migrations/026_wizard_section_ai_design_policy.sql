alter table wizard_content_sections
  add column if not exists ai_design jsonb not null default '{"enabled":true,"allowedLayoutVariants":["split-left","split-right","centered-hero"],"imageTarget":"section-background","imageTargetItemKeys":[],"imageAspectRatio":"16:9"}'::jsonb;
...
begin
  ...
  insert into wizard_content_sections (
    ...
    v_source.owner_form_template_id, v_source.ai_design
