...
module.exports = async function handler(req, res) {
  try {
    ...
    if (body.renderSpec != null) {
      return res.status(400).json({
        error: "RenderSpec cannot be supplied during direct component creation",
        message: "Create the draft first, then save RenderSpec using the server-generated immutable field keys.",
      });
    }
