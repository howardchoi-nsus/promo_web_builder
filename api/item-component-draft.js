  ...
  try {
    ...
    const rows = await sql`
      ...
      insert into wizard_item_component_versions (
        ...
        capabilities, image_policy, cta_policy, style_slots, placement_policy,
        ...
        source.render_contract_version, source.render_tree, source.render_responsive,
        source.render_accessibility, source.render_validation,
